...
export const MonthlyBudgetPlannerProvider = ({
	children,
	initialBudget,
}: MonthlyBudgetPlannerProviderProps) => {
...
export const useMonthlyBudgetPlannerContext = () => {
	...
	if (!context) {
		throw new Error(
			'useMonthlyBudgetPlannerContext must be used within a MonthlyBudgetPlannerProvider',
		);
	}
	return context;
};
